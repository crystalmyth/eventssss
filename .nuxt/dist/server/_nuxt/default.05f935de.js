import { v as vue_cjs_prod, q as useNuxtApp, _ as _export_sfc, p as __nuxt_component_0$1 } from "../server.mjs";
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_IncUprNavbar, null, null, _parent));
      _push(`<nav class="navbar"><div class="container-fluid"><div class="navbar-logo"><img lazy="loading"${ssrRenderAttr("src", Logo)} alt class="img-fluid"></div><div class="navbar-menu"><!--[-->`);
      ssrRenderList(menu, (link, index) => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<footer${ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "footer" }, _attrs))}><div class="container-fluid"><div class="footer-left"><h4>STAY UP TO DATE ON OUR LATEST TIPS</h4><p> Subscrible &amp; get <span>10%</span> discount. Get E-mail updates about our latest shop and `);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_IncNavbar, null, null, _parent));
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(ssrRenderComponent(_component_IncFooter, null, null, _parent));
  _push(`</div>`);
}
