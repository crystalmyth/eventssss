...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import("./error-404.6aff6169.js"));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import("./error-500.f79fb367.js"));
