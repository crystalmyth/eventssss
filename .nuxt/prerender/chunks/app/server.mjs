import proxy__default from 'file:///Applications/XAMPP/xamppfiles/htdocs/paean/ecommerce/frontend/node_modules/unenv/runtime/mock/proxy.mjs';
import { r as requireVue_cjs_prod, c as commonjsGlobal$1, s as serverRenderer, a as require$$1 } from '../renderer.mjs';
import { $fetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/paean/ecommerce/frontend/node_modules/ohmyfetch/dist/node.mjs';
import { joinURL, hasProtocol, isEqual } from 'file:///Applications/XAMPP/xamppfiles/htdocs/paean/ecommerce/frontend/node_modules/ufo/dist/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/paean/ecommerce/frontend/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Applications/XAMPP/xamppfiles/htdocs/paean/ecommerce/frontend/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sendRedirect } from 'file:///Applications/XAMPP/xamppfiles/htdocs/paean/ecommerce/frontend/node_modules/h3/dist/index.mjs';
import defu from 'file:///Applications/XAMPP/xamppfiles/htdocs/paean/ecommerce/frontend/node_modules/defu/dist/defu.mjs';
...
(function (module, exports) {
	(function (global, factory) {
	  factory(exports, requireVue_cjs_prod()) ;
...
const _sfc_main$g = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><div class="${serverRenderer.exports.ssrRenderClass([[__props.close ? "display" : ""], "product-filter"])}"><div class="container-fluid"><h2 class="sticky-top"> Product Categories <div class="product-filter-close"><i class="fa-solid fa-xmark"></i></div></h2><div class="product-filter-categories"><!--[-->`);
      serverRenderer.exports.ssrRenderList(categories.value, (category) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
          ...
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${serverRenderer.exports.ssrInterpolate(category.Title)} <span${_scopeId}>(5)</span>`);
            } else {
              return [
      ...
      serverRenderer.exports.ssrRenderList(occasions.value, (occasion) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
          key: occasion.Title,
          to: "/"
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${serverRenderer.exports.ssrInterpolate(occasion.Title)}`);
            } else {
              return [
      ...
      serverRenderer.exports.ssrRenderList(relations.value, (relation) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
          key: relation.Title,
          to: "/"
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${serverRenderer.exports.ssrInterpolate(relation.Title)}`);
            } else {
              return [
...
const _sfc_main$f = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "breadcrumb" }, _attrs))}><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(breadcrumbs), (breadcrumb) => {
        _push(`<span>${serverRenderer.exports.ssrInterpolate(breadcrumb)}</span>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "product-content" }, _attrs))}>`);
...
const _sfc_main$d = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e;
      const _component_nuxt_link = __nuxt_component_0$1;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "product-card shadow" }, _attrs))}><div class="product-card-discount">25%</div><div class="product-card-img"><div class="product-card-overlay"><div class="product-card-overlay-buttons"><i class="fa-solid fa-magnifying-glass-plus"></i><i class="fa-solid fa-heart"></i></div><div class="product-card-overlay-book">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
      ...
      _push(`</div></div><img lazy="loading"${serverRenderer.exports.ssrRenderAttr("src", `http://3.111.70.214:1337${(_b = vue_cjs_prod.unref(product)) == null ? void 0 : _b.image.url}`)} alt class="img-fluid"></div><div class="product-card-content"><h4> 4,500 <i class="fa-solid fa-indian-rupee-sign"></i><del>${serverRenderer.exports.ssrInterpolate((_c = vue_cjs_prod.unref(product)) == null ? void 0 : _c.price)} <i class="fa-solid fa-indian-rupee-sign"></i></del></h4><p class="product-card-content-title">${serverRenderer.exports.ssrInterpolate((_d = vue_cjs_prod.unref(product)) == null ? void 0 : _d.title)}</p><div class="product-card-content-rating"><!--[-->`);
      serverRenderer.exports.ssrRenderList((_e = vue_cjs_prod.unref(product)) == null ? void 0 : _e.rating, (n) => {
...
const _sfc_main$c = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "hero-section" }, _attrs))}><div class="container-fluid">`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Carousel), { "items-to-show": 1 }, {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            serverRenderer.exports.ssrRenderList(carousels.value, (slide) => {
              _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Slide), {
                key: slide.Title
              }, {
                default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img lazy="loading"${serverRenderer.exports.ssrRenderAttr("src", `http://3.111.70.214:1337${slide.Banner.url}`)} alt class="img-fluid"${_scopeId2}>`);
                  } else {
                    return [
            ...
            return [
              (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(carousels.value, (slide) => {
                return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.unref(carousel.exports.Slide), {
                  key: slide.Title
                }, {
...
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    const relations = vue_cjs_prod.ref([]);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "find-package shadow" }, _attrs))}><div class="container-fluid"><h4>Find Package</h4><form action="#" class="form"><div class="form-group"><select name id class="form-select rounded-0 shadow"><optgroup label="Occasions"><option value>Occasion</option><!--[-->`);
      serverRenderer.exports.ssrRenderList(occasions.value, (occasion) => {
        _push(`<option${serverRenderer.exports.ssrRenderAttr("value", occasion.Title)}>${serverRenderer.exports.ssrInterpolate(occasion.Title)}</option>`);
      });
      ...
      serverRenderer.exports.ssrRenderList(relations.value, (relation) => {
        _push(`<option${serverRenderer.exports.ssrRenderAttr("value", relation.Title)}>${serverRenderer.exports.ssrInterpolate(relation.Title)}</option>`);
      });
...
const _sfc_main$a = {
  ...
  setup(__props) {
    const occasions = vue_cjs_prod.ref([]);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "occation-section" }, _attrs))}><div class="container-fluid"><h2>Find By Occation</h2><div class="occation-section-list">`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Carousel), { "items-to-show": 4 }, {
        addons: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Pagination), null, null, _parent2, _scopeId));
          } else {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            serverRenderer.exports.ssrRenderList(occasions.value, (slide) => {
              _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Slide), {
                key: slide.Title
              }, {
                default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="occation-section-list-box shadow"${_scopeId2}><img lazy="loading"${serverRenderer.exports.ssrRenderAttr("src", `http://3.111.70.214:1337${slide.icon.url}`)} alt class="img-fluid"${_scopeId2}><div class="occation-section-list-box-content"${_scopeId2}><h4${_scopeId2}>${serverRenderer.exports.ssrInterpolate(slide.Title)}</h4><span${_scopeId2}>Products(4)</span></div><i class="fa-solid fa-angle-right"${_scopeId2}></i></div>`);
                  } else {
                    return [
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "today-deal" }, _attrs))}><div class="container-fluid"><h2>Today&#39;s Best Deals</h2><div class="today-deal-list">`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Carousel), { "items-to-show": 1 }, {
        addons: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Navigation), null, null, _parent2, _scopeId));
          ...
          if (_push2) {
            ...
            return [
              (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(10, (slide) => {
                return vue_cjs_prod.createVNode(vue_cjs_prod.unref(carousel.exports.Slide), { key: slide }, {
                  default: vue_cjs_prod.withCtx(() => [
                    vue_cjs_prod.createVNode("div", { class: "today-deal-list-box" }, [
                      vue_cjs_prod.createVNode("img", {
                        lazy: "loading",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "week-deal" }, _attrs))}><div class="container-fluid"><h2>This Week Deals</h2><div class="week-deal-list"><!--[-->`);
  serverRenderer.exports.ssrRenderList(5, (n) => {
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_nuxt_link = __nuxt_component_0$1;
      _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "trending" }, _attrs))}><div class="container-fluid"><h2>Trending Collections</h2><div class="trending-list"><div class="trending-list-box active">All Items</div><div class="trending-list-box">Sales</div><div class="trending-list-box">Featured</div><div class="trending-list-box">Best Seller</div></div><div class="trending-content"><!--[-->`);
      serverRenderer.exports.ssrRenderList(products.value, (product) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_PartProductCart, {
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "review" }, _attrs))}><div class="container-fluid"><h2>Cutomers Reviews</h2><div class="review-list">`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Carousel), { "items-to-show": 1 }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            serverRenderer.exports.ssrRenderList(reviews.value, (slide) => {
              _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Slide), {
                key: slide == null ? void 0 : slide.name
              }, {
                default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="review-box"${_scopeId2}><div class="review-box-img"${_scopeId2}><img lazy="loading"${serverRenderer.exports.ssrRenderAttr("src", `http://3.111.70.214:1337${slide == null ? void 0 : slide.image.url}`)} alt class="img-fluid"${_scopeId2}><h4${_scopeId2}>${serverRenderer.exports.ssrInterpolate(slide == null ? void 0 : slide.name)}</h4><span${_scopeId2}>${serverRenderer.exports.ssrInterpolate(slide == null ? void 0 : slide.location)}</span></div><div class="review-box-content"${_scopeId2}><div class="review-box-content-rating"${_scopeId2}><!--[-->`);
                    serverRenderer.exports.ssrRenderList(5, (n) => {
                      _push3(`<i class="fa-solid fa-star"${_scopeId2}></i>`);
                    });
                    _push3(`<!--]--></div><p${_scopeId2}>${serverRenderer.exports.ssrInterpolate(slide == null ? void 0 : slide.content)}</p></div></div>`);
                  } else {
                    return [
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "subscribe" }, _attrs))}><div class="container-fluid"><form action class="form"><h2> Subscribe &amp; Get <span>10%</span> Discont </h2><p> Get E-mail updates about our latest shop and `);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "featured-in" }, _attrs))}><div class="container-fluid"><div class="featured-in-list"><label for>Featured In</label>`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Carousel), { "items-to-show": 6 }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            serverRenderer.exports.ssrRenderList(companies.value, (slide) => {
              _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(carousel.exports.Slide), {
                key: slide == null ? void 0 : slide.title
              }, {
                default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img lazy="loading"${serverRenderer.exports.ssrRenderAttr("src", `http://3.111.70.214:1337${slide == null ? void 0 : slide.logo.url}`)} alt class="img-fluid"${_scopeId2}>`);
                  } else {
                    return [
                      vue_cjs_prod.createVNode("img", {
                        lazy: "loading",
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="${serverRenderer.exports.ssrRenderClass([[slide.value == "date" ? "" : "d-none"], "container"])}"><h2>SELECT EVENT DATE &amp; TIME</h2>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_v_date_picker, {
        "min-date": new Date(),
        color: "orange",
        mode: "date",
      ...
      _push(`<div class="buttons-date"><button class="btn btn-outline-danger"><i class="fa-solid fa-clock"></i> Select Time </button></div></div><div class="${serverRenderer.exports.ssrRenderClass([[slide.value == "time" ? "" : "d-none"], "container"])}"><h2>SELECT EVENT DATE &amp; TIME</h2><h4 id="date-picker-title">READY TIME?</h4><p>TAP BELOW TO SELECT TIME</p>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_v_date_picker, {
        mode: "time",
        modelValue: date.value,
        "onUpdate:modelValue": ($event) => date.value = $event,
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "product-card-rating" }, _attrs))}><!--[-->`);
      serverRenderer.exports.ssrRenderList(__props.stars, (n) => {
        _push(`<i class="fa-solid fa-star"></i>`);
      });
      _push(`<!--]--> (${serverRenderer.exports.ssrInterpolate(__props.rating)} Reviews) </div>`);
    };
  }
};
...
const routes = [
  {
    ...
    meta: meta$4,
    alias: [],
    component: () => import('./_nuxt/about.08083408.mjs').then((m) => m.default || m)
  },
  {
    name: "category",
    path: "/category",
    ...
    meta: meta$3,
    alias: [],
    component: () => import('./_nuxt/category.c5620e0b.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    meta: meta$2,
    alias: [],
    component: () => import('./_nuxt/contact.60755638.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    meta: meta$1,
    alias: [],
    component: () => import('./_nuxt/index.387d9e96.mjs').then((m) => m.default || m)
  },
  {
    name: "product-id",
    path: "/product/:id",
    ...
    meta,
    alias: [],
    component: () => import('./_nuxt/_id_.1db704a5.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./_nuxt/error-component.e77b3b46.mjs'));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: vue_cjs_prod.defineAsyncComponent(() => import('./_nuxt/default.05f935de.mjs'))
};
...
export { _export_sfc as _, _sfc_main$g as a, _sfc_main$f as b, __nuxt_component_4$1 as c, _sfc_main$d as d, entry$1 as default, _sfc_main$c as e, _sfc_main$b as f, _sfc_main$a as g, _sfc_main$9 as h, __nuxt_component_4 as i, _sfc_main$7 as j, _sfc_main$6 as k, __nuxt_component_7 as l, _sfc_main$4 as m, _sfc_main$3 as n, _sfc_main$2 as o, __nuxt_component_0$1 as p, useNuxtApp as q, useHead as r, useRoute as u, vue_cjs_prod as v };
